...
export const ProjectGrid: React.FC<ProjectGridProps> = ({ projects }) => {
  ...
  if (projects.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center p-12 text-center bg-zinc-900/60 border border-zinc-800/80 border-dashed rounded-lg">
        ...
        <div className="flex items-center gap-2.5">
          <button
            ...
            className="flex items-center gap-2 px-3.5 py-2 bg-zinc-100 hover:bg-zinc-200 text-zinc-950 rounded-md text-xs font-medium transition-colors shadow-sm cursor-pointer"
          >
          ...
          <button
            ...
            className="flex items-center gap-2 px-3.5 py-2 bg-zinc-900 hover:bg-zinc-800 border border-zinc-800 hover:border-zinc-700 text-zinc-300 rounded-md text-xs font-medium transition-colors cursor-pointer"
          >
            <IconScan size={15} />
